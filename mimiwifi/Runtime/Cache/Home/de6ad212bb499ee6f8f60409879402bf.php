        ...
        <div class="widget-content no-padding">
         <div class="row">
            <div class="dataTables_header clearfix">
				<div class="col-md-6">
					<a class="btn btn-primary" href="<?php echo U('add');?>">添加应用点</a>
              ...
              <div class="col-md-6 dataTables_filter">
                  ...
                  <div class="input-group search-form"> <span class="input-group-addon"><a id="search" href="javascript:;" id="search" url="<?php echo U('index');?>"><i class="icon-search"></i></a></span>
                    <input type="text" class="form-control search-input" placeholder="请输入应用点名称" name="sn" value="<?php echo I('sn');?>">
                  </div>
                  </label>
              </div>
            </div>
		...
		<table class="table table-striped table-bordered table-hover table-checkable align-center">
            <thead>
              <tr>
                ...
                <td class="text-left">
				  简称 <?php echo ($vo["mac"]); ?></br>
				  全程: <?php echo ($vo["version"]); ?>
				</td>
                <td class="text-left">
				  大类: <?php echo ($vo["mac"]); ?></br>
				  小类: <?php echo ($vo["sn"]); ?></br>
				  备注: <?php echo ($vo["version"]); ?>
				</td>
				<td class="text-left">
				  省:　　　市:</br>
				  区: 　 <span><i class="icon-search"></i> <a href="<?php echo U('User/edit?id='.$vo['uid']);?>" class="confirm-dialog">详细</a></span></br>
				  街道:　　　　
				</td>
				<td class="text-left">
				  联系人: <?php echo ($vo["gw_ip"]); ?></br>
				  电话: <?php echo ($vo["gw_ip"]); echo ($vo["gw_port"]); ?></br>
				  QQ: <?php echo ($vo["wan_ip"]); ?></br>
				  最后更新:<?php echo ($vo["vpn_cip"]); ?>
				</td>
				<td>
				  路由器1</br>
				  路由器2</td>
				<td>
				  用户：1211<?php echo ($vo["uid"]); ?>
				</td>
				<td>
