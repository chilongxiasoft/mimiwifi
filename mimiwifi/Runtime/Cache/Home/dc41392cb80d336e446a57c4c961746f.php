...
<!--  <link href="/Public/default/assets/css/module.css" rel="stylesheet" type="text/css" /> -->
  ...
  <div class="page-header">
    <div class="page-title">
	  ...
	  <span><a href="<?php echo U('AuthManager/index');?>" class="btn"><< 返回</a></span>
    </div>
  </div>
<div class="row">
  <div class="col-md-12">
    <div class="widget box">
	  ...
	  切换用户组：
			...
			<!-- 访问授权 -->
				<form action="<?php echo U('AuthManager/writeGroup');?>" enctype="application/x-www-form-urlencoded" method="POST" class="form-horizontal">
