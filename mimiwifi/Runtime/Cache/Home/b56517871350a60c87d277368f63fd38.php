...
<html lang="en">
  ...
  <div class="row">
	...
	<form id="form" action="<?php echo U('saveDevice');?>" method="post" class="form-horizontal   row-border">
		<div class="form-group">
			<label class="col-md-2 control-label">设备MAC</label>
			<div class="col-md-10">
				<input type="text" class="form-control input-width-large" name="mac" value="<?php echo ($data["mac"]); ?>">
				<span class="help-block">（设备MAC地址）</span>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-2 control-label">SN序列号</label>
			<div class="col-md-10">
				<input type="text" class="form-control input-width-large" name="sn" value="<?php echo ($data["sn"]); ?>">
				<span class="help-block">（设备SN序列号）</span>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-2 control-label">所属用户ID</label>
			<div class="col-md-10">
				<input type="text" class="form-control input-width-large" name="uid" value="<?php echo ($data["uid"]); ?>">
				<span class="help-block">（设备所属用户ID）</span>
			</div>
		</div>
		<div class="form-group">
