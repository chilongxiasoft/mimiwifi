...
class Page2{
    ...
    private $config  = array(
        'header' => '<div class="col-md-6"><div class="dataTables_info">共 %TOTAL_ROW% 条记录</div></div><div class="col-md-6"><div class="dataTables_paginate paging_bootstrap"><ul class="pagination">',
        'prev'   => '<<上一页',
        'next'   => '下一页>>',
        'first'  => '1...',
        'last'   => '...%TOTAL_PAGE%',
    ...
    public function show() {
        ...
        $down_page = ($down_row <= $this->totalPages) ? '<li class="next"><a href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a></li>' : '<li class="prev disabled"><a href="#">' . $this->config['next'] . '</a></li>';
