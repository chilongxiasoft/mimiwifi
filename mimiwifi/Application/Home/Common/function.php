 ...
 *
 */
function int_to_string(&$data,$map=array('status'=>array(1=>'<label class="label label-success">正常</label>',-1=>'删除',0=>'<label class="label label-danger">锁定</label>',2=>'未审核',3=>'草稿'),'usertype'=>array(0=>'<label class="label label-danger">未设置</label>',1=>'<label class="label label-primary">&nbsp;用&nbsp;户&nbsp;</label>',2=>'<label class="label label-info">代理商</label>',3=>'<label class="label label-admin">管理员</label>'))) {
