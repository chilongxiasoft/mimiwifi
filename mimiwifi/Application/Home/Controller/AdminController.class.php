...
class AdminController extends Controller {
    ...
    protected function _initialize(){
        ...
        $this->assign('thisgourp', $this->getGroup());
    }
     ...
     * @author a-ze <592358@qq.com>
     */
    final public function getGroup($controller=CONTROLLER_NAME){
		$gcurrent = M('Menu')->where("url like '%{$controller}%' AND pid != 0")->field('group')->find();
		// dump($gcurrent);
		// die;
    ...
    protected function lists ($model,$where=array(),$order='',$base = array('status'=>array('egt',0)),$field=true){
        ...
        $page = new \Think\Page2($total, $listRows, $REQUEST);
